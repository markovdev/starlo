        ...
        <React.Fragment>
          ...
          <nav className="navbar">
            ...
            <ul className="navbar__list">
              ...
              {context.userData.token ? navLink("Settings", "/me") : null}
              {!context.userData.token ? navLink("Login", "/login") : null}
              {!context.userData.token ? navLink("Signup", "/signup") : null}
            </ul>
            <div>
              {context.userData.token ? (
                <Link className="navbar__user" to="/me">
                  <img
                    src={`/img/users/${context.userData.photo}`}
                    alt={`${context.userData.name} photo`}
                    className="navbar__user__pic"
                  />
                  <p className="navbar__user__name">{context.userData.name}</p>
                </Link>
              ) : null}
            </div>
          </nav>
